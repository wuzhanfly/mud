...
- dfc2d64: Fixed an issue where the sync progress was not moving to "live" when synced from the MUD indexer's live logs API.
...
- 84ae33b: Added experimental support for syncing state from pending logs.
